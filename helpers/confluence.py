...
def get_page_id(base_url, space_key, page_title, username, api_token):
    ...
    response = requests.get(url, headers=get_headers(username,api_token), params=params)
...
def get_page_content(base_url: str, page_id: str, username: str, api_token: str) -> str or None:
