...
def infer_category(query):
    performance_keywords = ['appraisal', 'performance', 'achievements', 'contributions', 'endorsements', 'career']
...
def conversational_ui():
    ...
    user_input = st.text_input("Ask me anything about your performance, learning, productivity, or any other questions:", key="user_input")
